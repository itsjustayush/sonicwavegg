...
| Framing | Three preamble chords, one sync chord, then packet symbols |
| Packet | Magic byte, sequence, UTF-8 payload length, payload, CRC-8, XOR parity, modular-sum parity |
| Redundancy | Lightweight Reed–Solomon-inspired dual parity plus CRC-8 detection; invalid frames are rejected rather than displayed |
